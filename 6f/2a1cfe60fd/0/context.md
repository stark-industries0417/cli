...
we have #343, #323 and this one #342 open right now; I'm trying to figure out how to sequence these

### Prompt 14

whoop, 343 just went in 😅

### Prompt 15

ok, 323 is in, let's rebase
...
this is more of a logging concern I reckon, we can't do much about that situation?

### Prompt 18

what are the failure conditions for transcript extraction?

### Prompt 19

reply to bugbot and dismiss it

### Prompt 20

have a look at e2e-artifacts/TestSingleSessionSubagentCommitInTurn-claude-code/

there is a failed e2e test in there, the logs, git output and link to the repo are there.

the scenario is a subagent commit with claude, this is a regression

### Prompt 21

ok, 2 points:
1. can we just revert that 'fix' commit?
2. can we add this to KNOWN_LIMITATIONS?
